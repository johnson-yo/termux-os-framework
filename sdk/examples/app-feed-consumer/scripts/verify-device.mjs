 ...
 * [POS]: Device verification for the SDK app example.
...
await check('package_identity', () => get('/api/packages/github.termux-os.app.example-feed-consumer'));
await check('status_api', () => get('/api/packages/github.termux-os.app.example-feed-consumer/status'));

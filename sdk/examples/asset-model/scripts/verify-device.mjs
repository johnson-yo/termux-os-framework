 ...
 * [POS]: Device verification for the SDK asset example.
...
await check('package_identity', () => get('/api/packages/github.termux-os.asset.example-model'));
await check('status_api', () => get('/api/packages/github.termux-os.asset.example-model/status'));

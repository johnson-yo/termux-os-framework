 ...
 * [POS]: Device verification for the SDK adapter example.
...
await check('package_identity', () => get('/api/packages/github.termux-os.adapter.example-http'));
await check('config_api', () => get('/api/packages/github.termux-os.adapter.example-http/config'));

...
Release verification binds evidence to Package ID, version, target, archive SHA-256, and Framework build. `--dev` may test a source repository during iteration, but its result is not release evidence.
